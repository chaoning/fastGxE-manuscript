...
#SBATCH --output=/net/zootopia/disk1/chaon/WORK/GxE/simuR1/script/power_features/Aout/mom/%a.txt
#SBATCH --error=/net/zootopia/disk1/chaon/WORK/GxE/simuR1/script/power_features/Aerr/mom/%a.txt
    ...
    for h2_add in 30; do
        ...
        if [ ${k} -eq ${SLURM_ARRAY_TASK_ID} ]; then
			...
			time fastgxe --mom  \
                ...
                --threads 10 \
                --out ../res_baselineLD_mom/$prefix.rep_$rep
