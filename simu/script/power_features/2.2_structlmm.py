...
os.chdir(f"/net/zootopia/disk1/chaon/WORK/GxE/simuR1/power/pheno_feature_fastgxe/")

logging.info("Plink file")
bed_file = f"../pheno_feature/{prefix}.rep_{rep}.power_snps"
...
dfM.to_csv(f"../res_structlmm_feature/{prefix}.{rep}.csv", index=False)
