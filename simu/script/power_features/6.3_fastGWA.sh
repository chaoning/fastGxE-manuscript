...
#SBATCH --array=1-4000%1000
#SBATCH --cpus-per-task=5
#SBATCH --time=10-00:00:00
#SBATCH --output=/net/zootopia/disk1/chaon/WORK/GxE/simuR1/script/power_features/Aout/fastGWA/%a.txt
#SBATCH --error=/net/zootopia/disk1/chaon/WORK/GxE/simuR1/script/power_features/Aerr/fastGWA/%a.txt
#SBATCH --mem-per-cpu=5000MB
#SBATCH --partition=mulan,main
#SBATCH --exclude=mulan-mc[01-03]

bash
cd /net/zootopia/disk1/chaon/WORK/GxE/simuR1/null/res_baselineLD_fastGWA/
