...
#SBATCH --output=/net/zootopia/disk1/chaon/WORK/GxE/simuR1/script/power_features/Aout/power/structlmm/%a.txt
#SBATCH --error=/net/zootopia/disk1/chaon/WORK/GxE/simuR1/script/power_features/Aerr/power/structlmm/%a.txt
...
for rep in {1..100}; do
	...
	for nBin in {1..6}; do
		...
		if [ ${k} -eq ${SLURM_ARRAY_TASK_ID} ]; then
			...
			python /net/zootopia/disk1/chaon/WORK/GxE/simuR1/script/power_features/2.2_structlmm.py $prefix $sample_size $rep
