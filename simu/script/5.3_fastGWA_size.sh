...
#SBATCH --array=1-16000%1000
#SBATCH --cpus-per-task=5
#SBATCH --time=10-00:00:00
#SBATCH --output=/net/zootopia/disk1/chaon/WORK/GxE/simuR1/script/Aout/fastGWA_size/size.%a.txt
#SBATCH --error=/net/zootopia/disk1/chaon/WORK/GxE/simuR1/script/Aerr/fastGWA_size/size.%a.txt
