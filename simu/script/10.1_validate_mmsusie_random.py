...
MS.out_mmsusie(res, f"/net/zootopia/disk1/chaon/WORK/GxE/simuR1/null/validate_mmsusie_random/{rep}.{input_window_index}.mmsusie_out")

with open(f"/net/zootopia/disk1/chaon/WORK/GxE/simuR1/null/validate_mmsusie_random/{rep}.{input_window_index}.mmsusie_out.lead_snp", "w") as f:
    f.write(lead_snp + "\n")

pip, alpha, mu, sets = susie(EG, y)

np.savetxt(f"/net/zootopia/disk1/chaon/WORK/GxE/simuR1/null/validate_mmsusie_random/{rep}.{input_window_index}.susie.pip", pip)
np.savetxt(f"/net/zootopia/disk1/chaon/WORK/GxE/simuR1/null/validate_mmsusie_random/{rep}.{input_window_index}.susie.alpha", alpha)
np.savetxt(f"/net/zootopia/disk1/chaon/WORK/GxE/simuR1/null/validate_mmsusie_random/{rep}.{input_window_index}.susie.mu", mu)
