...
MS.out_mmsusie(res, f"/net/zootopia/disk1/chaon/WORK/GxE/simuR1/null/AIE_split_mmsusie/{rep}.{input_window_index}.mmsusie_out")

with open(f"/net/zootopia/disk1/chaon/WORK/GxE/simuR1/null/AIE_split_mmsusie/{rep}.{input_window_index}.mmsusie_out.lead_snp", "w") as f:
    f.write(lead_snp + "\n")
