...
os.chdir("/net/zootopia/disk1/chaon/WORK/GxE/simuR1/null/AIE_split_mmsusie/")
...
os.chdir("/net/zootopia/disk1/chaon/WORK/GxE/simuR1/null/AIE_split_group/")
...
os.chdir("/net/zootopia/disk1/chaon/WORK/GxE/simuR1/null/AIE_split_test_main/")
