...
#SBATCH --output=/net/zootopia/disk1/chaon/WORK/GxE/simuR1/script/prefilter/Aout/fastgxe_testgxe/%a.txt
#SBATCH --error=/net/zootopia/disk1/chaon/WORK/GxE/simuR1/script/prefilter/Aerr/fastgxe_testgxe/%a.txt
	...
	for add_gxe_ratio in 0.005 0.25 1 2 4; do
		for rep in {1..100}; do
			...
			if [ ${k} -eq ${SLURM_ARRAY_TASK_ID} ]; then
					...
					prefix=rGI_$rGI.add_gxe_ratio_$add_gxe_ratio.num_envi_30.h2_add_30.h2_gxe_5.h2_nxe_15.sample_100000
