...
#SBATCH --output=/net/zootopia/disk1/chaon/WORK/GxE/simuR1/script/prefilter/Aout/simu_power/%a.txt
#SBATCH --error=/net/zootopia/disk1/chaon/WORK/GxE/simuR1/script/prefilter/Aerr/simu_power/%a.txt
