...
out_file = f"/net/zootopia/disk1/chaon/WORK/GxE/simuR1/null/QQ_plot/{prefix}_nofastGxE_noNxE"
...
p_arr_lst = [p_fastgxe_arr, p_fastgxe_noNxE_arr, p_structlmm_arr, p_fastGWA_arr]
color_lst = ["#376795", "#ffd06f", "#06948E", "#e76254"]
label_lst = ["fastGxE", "fastGxE-noNxE", "structLMM", "fastGWA-GE"]
out_file = f"/net/zootopia/disk1/chaon/WORK/GxE/simuR1/null/QQ_plot/{prefix}"
dfR.to_csv(out_file + ".csv", index=False)
qqplot(p_arr_lst, color_lst, label_lst, out_file, output_format="png")
qqplot_pure(p_arr_lst, color_lst, label_lst, out_file + "_pure", output_format="png")
qqplot_frame(p_arr_lst, color_lst, label_lst, out_file + "_frame", output_format="pdf")
