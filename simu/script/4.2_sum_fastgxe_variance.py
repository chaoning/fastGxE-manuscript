...
os.chdir("/net/zootopia/disk1/chaon/WORK/GxE/simuR1/null/res_fastgxe_variance/")
...
dfR.to_csv(f"../res_fastgxe_variance_sum/Varying_h2_gxe.csv", index=False)
...
dfR = pd.DataFrame(res_dct)
dfR.to_csv(f"../res_fastgxe_variance_sum/Varying_h2_nxe.csv", index=False)
