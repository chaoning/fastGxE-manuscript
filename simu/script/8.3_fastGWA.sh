...
#SBATCH --array=1-56000%200
#SBATCH --cpus-per-task=5
#SBATCH --time=1-00:00:00
#SBATCH --output=/net/zootopia/disk1/chaon/WORK/GxE/simuR1/script/Aout/power/fastGWA/%a.txt
#SBATCH --error=/net/zootopia/disk1/chaon/WORK/GxE/simuR1/script/Aerr/power/fastGWA/%a.txt
...
cd /net/zootopia/disk1/chaon/WORK/GxE/simuR1/power/res_fastGWA/
