...
data_fastGxE <- read.csv("/net/zootopia/disk1/chaon/WORK/GxE/simuR1/null/res_mom_sum/Varying_h2_nxe.csv")
...
data_GENIE <- read.csv("/net/zootopia/disk1/chaon/WORK/GxE/simuR1/null/res_GENIE_sum/Varying_h2_nxe2.csv")
...
png("h2gxe_vs_nxe2.png", width = 8, height = 6, units = "cm", res = 300)
print(plot)
dev.off()
