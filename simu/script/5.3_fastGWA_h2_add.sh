...
#SBATCH --array=1-8000%500
#SBATCH --cpus-per-task=5
#SBATCH --time=10-00:00:00
#SBATCH --output=/net/zootopia/disk1/chaon/WORK/GxE/simuR1/script/Aout/fastGWA/h2_add.%a.txt
#SBATCH --error=/net/zootopia/disk1/chaon/WORK/GxE/simuR1/script/Aerr/fastGWA/h2_add.%a.txt
