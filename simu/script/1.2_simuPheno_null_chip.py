...
# Define file paths
bed_file = "/net/zootopia/disk1/chaon/data/UKB/chip/ukb.keep.qc"
...
out_prefix = f"chip.h2_add_{sys.argv[1]}.h2_gxe_{sys.argv[2]}.h2_nxe_{sys.argv[3]}.sample_{sample_size}.rep_{rep}"
