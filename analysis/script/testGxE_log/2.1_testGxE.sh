#!/bin/bash
#SBATCH --job-name=PT
#SBATCH --array=1-320%200
#SBATCH --cpus-per-task=5
#SBATCH --time=1-00:00:00
#SBATCH --output=/net/zootopia/disk1/chaon/WORK/GxE/Analysis/R1/script/testGxE_log/Aout/testgxe_physical/%a.txt
#SBATCH --error=/net/zootopia/disk1/chaon/WORK/GxE/Analysis/R1/script/testGxE_log/Aerr/testgxe_physical/%a.txt
