...
#SBATCH --output=/net/zootopia/disk1/chaon/WORK/GxE/Analysis/R1/script/testGxE_rawY/Aout/testgxe_physical/%a.txt
#SBATCH --error=/net/zootopia/disk1/chaon/WORK/GxE/Analysis/R1/script/testGxE_rawY/Aerr/testgxe_physical/%a.txt
...
k=0
npart=10
cd /net/zootopia/disk1/chaon/WORK/GxE/Analysis/R1/physical/testGxE_rawY/
   ...
   for ipart in $(seq 1 $npart); do
		...
		if [ ${k} -eq ${SLURM_ARRAY_TASK_ID} ]; then
			fastgxe --test-gxe --grm /net/zootopia/disk1/chaon/data/UKB/GRM/ukb_imp \
				...
				--data /net/zootopia/disk1/chaon/WORK/GxE/pheno/Physical_measures/pheno.e42.$trait.txt --trait $trait \
