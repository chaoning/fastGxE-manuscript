...
os.chdir("/net/zootopia/disk1/chaon/WORK/GxE/Analysis/R1/biomarker/testGxE/")

df = pd.read_csv("/net/zootopia/disk1/chaon/WORK/GxE/Analysis/R1/biomarker/trait67_shortName.txt",
                 sep="\t")
...
df_res.to_csv("/net/zootopia/disk1/chaon/WORK/GxE/Analysis/R1/script/biomarker_trait_replicate_n.txt", sep="\t", index=False)
