...
dfD = pd.read_csv("/net/zootopia/disk1/chaon/WORK/GxE/Analysis/R1/biomarker/results/FUMA/GenomicRiskLoci.hg38.keygenes.TraitSpecific.addP.csv")

k = int(sys.argv[1]) - 1
snp = dfD.loc[k, "trait_leading_snp"]
chr = dfD.loc[k, 'chrom_x']
loci = dfD.loc[k, 'GenomicLocus']
