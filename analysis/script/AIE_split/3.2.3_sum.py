...
def process_trait_specific(summary_csv, out_csv, trait_type):
    ...
    trait_lst = dfS.iloc[:, 13].to_list()
    snp_lst = dfS.iloc[:, 14].to_list()
...
process_trait_specific(
    ...
    "/net/zootopia/disk1/chaon/WORK/GxE/Analysis/R1/results/AIE_split/PT_trait_specific_lm.csv",
    "PT"
)
...
process_trait_specific(
    ...
    "/net/zootopia/disk1/chaon/WORK/GxE/Analysis/R1/results/AIE_split/BB_trait_specific_lm.csv",
    "BB"
)
