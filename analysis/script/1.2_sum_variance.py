...
k = 0
with open("/net/zootopia/disk1/chaon/WORK/GxE/Analysis/R1/physical/results/variance.txt", "w") as fout:
    fout.write("Trait\th2_1\th2_2\th2_gxe1\th2_gxe2\th2_nxe\tLRT_stat\tp_nxe\n")
    for trait in df.iloc[:, 0]:
        file = f"/net/zootopia/disk1/chaon/WORK/GxE/Analysis/R1/physical/mom/{trait}.var"
        var1 = np.loadtxt(file)
        file = f"/net/zootopia/disk1/chaon/WORK/GxE/Analysis/R1/physical/mom/{trait}_noNxE.var"
        ...
        k += 1
        file = f"/net/zootopia/disk1/chaon/WORK/GxE/Analysis/R1/script/Aout/fastgxe_physical.{k}.txt"
        LRT_stat = 0
        p_val = 0
