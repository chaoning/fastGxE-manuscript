#!/bin/bash
#SBATCH --job-name=MoM
#SBATCH --array=1-134%30
#SBATCH --cpus-per-task=20
#SBATCH --time=7-00:00:00
#SBATCH --output=/net/zootopia/disk1/chaon/WORK/GxE/Analysis/R1/script/Aout/MoM_biomarker.%a.txt
#SBATCH --error=/net/zootopia/disk1/chaon/WORK/GxE/Analysis/R1/script/Aerr/MoM_biomarker.%a.txt
...
cd /net/zootopia/disk1/chaon/WORK/GxE/Analysis/R1/biomarker/mom/
