...
# Directories
base_dir = "/net/zootopia/disk1/chaon/WORK/GxE/Analysis/R1/physical"
merge_dir = os.path.join(base_dir, "testGxE_merge")

# Read traits
trait_file = os.path.join(base_dir, "trait32.txt")
...
cols_to_use = [
    ...
    "p_gxe", "p_gxe_liu", "p_gxe_noNxE", "p_gxe_noNxE_liu",
    "p_SGEM_O", "p_gxe_log", "p_gxe_log_liu"
]
...
# Combine and save
output_file = f"/net/zootopia/disk1/chaon/WORK/GxE/Analysis/R1/physical/signal/{trait}.signal.txt"
