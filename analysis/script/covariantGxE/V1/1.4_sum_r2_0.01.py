...
file_lst = glob.glob("*.cov_singleE.r20.01.csv")
...
res_df.to_csv("/net/zootopia/disk1/chaon/WORK/GxE/Analysis/R1/script/covariantGxE/1.4_sum_singleE.r20.01.csv", index=False)
...
file_lst = glob.glob("*.cov_allE.r20.01.csv")
...
res_df.to_csv("/net/zootopia/disk1/chaon/WORK/GxE/Analysis/R1/script/covariantGxE/1.4_sum_cov_allE.r20.01.csv", index=False)
