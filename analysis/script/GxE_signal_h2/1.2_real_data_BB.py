...
dfS = pd.read_csv("/net/zootopia/disk1/chaon/WORK/GxE/Analysis/R1/script/AIE_split/3.2.3_sum.BB_trait_specific.csv", usecols=["GenomicLocus_hg38", "Genes", "trait", "trait_leading_snp"])
dfS.rename(columns={"trait_leading_snp": "SNP"}, inplace=True)

file = f"/net/zootopia/disk1/chaon/WORK/GxE/Analysis/Biological_samples/result/SGEM/sig/sum.sig.IINT.txt"
...
output_path = f"/net/zootopia/disk1/chaon/WORK/GxE/Analysis/R1/script/GxE_signal_h2/1.2_real_data_BB.csv"
