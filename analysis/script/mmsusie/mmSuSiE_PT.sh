...
tail -n +2 "/net/zootopia/disk1/chaon/WORK/GxE/Analysis/R1/physical/results/FUMA/GenomicRiskLoci.hg38.keygenes.TraitSpecific.addP_logP.csv" | while IFS= read -r line; do
    ...
    if [ ${k} -eq ${SLURM_ARRAY_TASK_ID} ]; then
		...
		/net/zootopia/disk1/chaon/WORK/GxE/pheno/Physical_measures/IINT/pheno.e42.$trait.txt \
		/net/zootopia/disk1/chaon/WORK/GxE/Analysis/R1/physical/testGxE/$trait.var 
    fi
done
