...
# get trait list
dfT = pd.read_csv("/net/zootopia/disk1/chaon/WORK/GxE/Analysis/R1/script/gif/BB_trait4.txt",
                  sep=r"\s+")
...
out_file = f"/net/zootopia/disk1/chaon/WORK/GxE/Analysis/R1/results/gif/QQ.traits4.BB"
